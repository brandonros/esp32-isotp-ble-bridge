...
#define REPLY_ARBITRATION_ID (uint32_t)0x7E8 // TODO: support more than just 1 arbitration ID through filters
...
extern uint8_t twai_rx_buf[CAN_FRAME_SIZE];

extern twai_message_t rx_message;
extern twai_message_t tx_message;

extern std::mutex can_mtx;
